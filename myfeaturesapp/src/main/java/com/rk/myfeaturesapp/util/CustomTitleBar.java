package com.rk.myfeaturesapp.util;
...
public class CustomTitleBar extends RelativeLayout {
     ...
     * 设置右侧文字
     */
    public void setRightTitle(String rightTitle, View.OnClickListener listener){
     ...
     * 设置右侧图片
     */
    public void setRightImg(int img, View.OnClickListener listener){
        tvMore.setVisibility(View.GONE);
        ivMore.setVisibility(View.VISIBLE);
        if(img>0){
